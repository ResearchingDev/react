...
const SignUp: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    let isValid = true;
    const newErrors = { first_name: '', user_name: '', email: '', password: '', confirm_password: '', phone_number: ''};
    // Validate First Name
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Simple application to be developed with a focus on scalability, maintainability, and ease of future enhancements
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleRegSubmit}>
                ...
                <div className="mb-4">
                  <Label htmlFor="user_name" text="Username" required/>
                  <div className="relative">
                    <InputField
                      type="text" 
                      name="user_name" 
                ...
                <div className="mb-6">
                  <Label htmlFor="confirm_password" text="Re-type Password" required/>
                  <div className="relative">
                    <InputField
                      type="password"
